...
CREATE TABLE pantax.patient (id INT UNSIGNED NOT NULL AUTO_INCREMENT, name VARCHAR(512) NOT NULL, birthday DATE NULL, marital_status VARCHAR(512) NULL, occupation VARCHAR(512) NULL, address VARCHAR(2048) NULL, picture_url VARCHAR(1000) NULL, PRIMARY KEY (id)) ENGINE=InnoDB;
...
CREATE TABLE pantax.appointment (id INT UNSIGNED NOT NULL AUTO_INCREMENT, patient_id INT UNSIGNED NOT NULL, weight int NULL, height int NULL, blood_pressure varchar(20) NULL, temperature float NULL, appointment_reason VARCHAR(4096) NULL, additional_info TEXT NULL, PRIMARY KEY (id)) ENGINE=InnoDB;
